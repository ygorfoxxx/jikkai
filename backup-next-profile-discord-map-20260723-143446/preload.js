...
contextBridge.exposeInMainWorld("jikkaiDesktop", {
  ...
  showOverlayPanel: (section) => ipcRenderer.invoke("overlay:show-panel", section || ""),
  ...
  setOverlayLayout: (layout, options) => ipcRenderer.invoke("overlay:set-layout", layout || "panel", options || {}),
